...
image_2_carousel:
  - image: "assets/images/projects/vending-machine-images/image_2.webp"
    caption:

c3_carousel:
  - image: "assets/images/projects/vending-machine-images/carousel_3_1.webp"
    caption:
  - image: "assets/images/projects/vending-machine-images/carousel_3_2.webp"
    caption:
  - image: "assets/images/projects/vending-machine-images/carousel_3_3.webp"
    caption:
  - image: "assets/images/projects/vending-machine-images/carousel_3_4.webp"
    caption:

c4_carousel:
  - image: "assets/images/projects/vending-machine-images/carousel_4_1.webp"
    caption:
  - image: "assets/images/projects/vending-machine-images/carousel_4_2.webp"
    caption:
  - image: "assets/images/projects/vending-machine-images/carousel_4_3.webp"
    caption:
  - image: "assets/images/projects/vending-machine-images/carousel_4_4.webp"
    caption:

c5_carousel:
  - image: "assets/images/projects/vending-machine-images/carousel_5_1.webp"
    caption:
  - image: "assets/images/projects/vending-machine-images/carousel_5_2.webp"
    caption:
...
{% include carousel.html images=page.image_1_carousel %}
...
Some goals I had in my recreation of the vending machine were to make it
Accessible and engaging for people not familiar with the SCP
Reusable (the original cardboard frame basically fell apart completely at the end of a single use)
Transportable on public transportation by 1 or 2 people (the SCP machine had to be hauled on a dolly and stabilized by several people, even when only transported a quarter mile)
Compact and easy to assemble and disassemble (I lived in a shared triple room at in a co-op at the time, and the garage only had a small slot of available for the storage of my belongings)
...
{% include carousel.html images=page.image_2_carousel %}
...
{% include carousel.html images=page.c3_carousel %}

{% include carousel.html images=page.c4_carousel %}
...
{% include carousel.html images=page.c5_carousel %}